...
if (window.engageDigitalClickToCallConfig) {
  ...
  document.getElementById(engageClickToCallConfig.showImage).style.visibility =
    "visible";
  document.getElementById(engageClickToCallConfig.showImage).style.display =
    "block";
}
...
function initializeEngageDigitalClickToCall(engageDigitalClickToCallConfig) {
  ...
  engageLog("Starting");
  engageMakeCallBtn = document.getElementById(
    engageClickToCallConfig.callBtnId
  );
  ...
  engageRemoteAudio = document.getElementById(
    engageClickToCallConfig.remoteAudioId
  );
...
function registerForEngageDigitalClientEvents() {
  ...
  engageDigitalClient.addEventHandler("ready", () => {
    ...
    document.getElementById(
      engageClickToCallConfig.showImage
  ...
  engageDigitalClient.addEventHandler("disconnected", () => {
    ...
    engageLog(
      "Disconnected from Engage Digital during the call state " +
        engageCallState.name
    );
...
function onNewEngageSession(session) {
  ...
  engageDigitalSession.addEventHandler("ringing", () => {
    ...
    document.getElementById(
      engageClickToCallConfig.ringingImage
    ).style.visibility = "visible";
    document.getElementById(
      engageClickToCallConfig.ringingImage
    ).style.display = "block";
    ...
    document.getElementById(engageClickToCallConfig.showImage).style.display =
      "none";
    document.getElementById(
      engageClickToCallConfig.connectedImage
    ).style.visibility = "hidden";
    document.getElementById(
      engageClickToCallConfig.connectedImage
    ).style.display = "none";
